...
function navio(selection, _h) {
  ...
  // The settings panel, and the composition root for the slice extracted in
  // #67: it constructs the theme and storage modules itself, so navio.js has a
  // single thing to build. See
  // docs/ai/2026-08-20-navio-decomposition-design.md.
  //
  // Constructed HERE, not at the top of the closure. It registers seven public
  // methods on nv, and OPTION_NAMES snapshots Object.keys(nv) at ~336 - build
  // it any earlier and getOptions() starts reporting those methods as options,
  // which 104-describe.spec.js rejects.
  ...
  function updateWidthAndHeight() {
    ...
    settings.positionButton(ctxHeight - 22);
  }
