...
function navio(selection, _h) {
  ...
  // Settings serialisation and persistence. It reaches the panel only through
  // `hooks` - redrawing an open panel, and the fold state of its sections - so
  // the dependency runs one way and the two stay constructible.
  ...
  const { persistSettings, maybeRestoreSettings } = _storage;
