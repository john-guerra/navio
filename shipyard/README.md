...
## Deploy URL
[Live Demo](https://john-guerra.github.io/Navio/data-explorer/build/index.html)

## GitHub URL

[Repository](https://github.com/john-guerra/Navio/data-explorer)

## Synopsis
The Data - explorer is a web application that eases the use of the Navio without programming. The Navio is a d3 visualization widget to helps summarizing, exploring and navigating large network visualizations.
