...
```
2. Create and import a new JavaScript file below the scripts (d3, netClustering, forceInABox and NodeNavigator) or right in the html like in the example below.
```html
<script src="path/to/d3.v4.min.js"></script>
<script src="path/to/netClustering.js"></script>
<script src="path/to/forceInABox.js"></script>
...
/*here is where you set the columns (attributes) that the widget will display. you can add categorical or sequential attribute. Both receive as a parameter the name and an optional scale.
...
4. Now you have a basic visualization. It has no animation, drag, clustering or onHover effects but the widget will be fully functional.
